...
const en = {
  ...
  "gh.pickRepo": "Which repository?",
  "gh.pickRepoHelp": "MineCommit can only see repositories you have given it access to.",
  "gh.noRepos": "MineCommit does not have access to any repository yet.",
  "gh.createOnGitHub": "Create one on GitHub",
  "gh.chooseRepos": "Choose which repositories MineCommit can use",
  "gh.addAnother": "Use a different repository",
  "gh.loadingRepos": "Looking for your repositories…",
  "gh.refreshRepos": "Check again",
  "gh.private": "private",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "gh.pickRepo": "使用哪个仓库？",
  "gh.pickRepoHelp": "MineCommit 只能看到你授权过的仓库。",
  "gh.noRepos": "MineCommit 还没有任何仓库的访问权限。",
  "gh.createOnGitHub": "在 GitHub 上创建一个",
  "gh.chooseRepos": "选择 MineCommit 可以使用的仓库",
  "gh.addAnother": "使用其他仓库",
  "gh.loadingRepos": "正在查找你的仓库…",
  "gh.refreshRepos": "重新检查",
  "gh.private": "私有",
